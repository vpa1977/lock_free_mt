...
//	CTCommandSender<CCommand_LaunchSection>::SendCommand( SECTION_ID_SYSTEM, CCommand_LaunchSection(CSectionB_CLSID,555) );

//	CTCommandSender<CCommand_LaunchSection>::SendCommand( SECTION_ID_SYSTEM, CCommand_LaunchSection(CSectionB_CLSID,666,SF_BOUND) );
//	CTCommandSender<CCommand_LaunchSection>::SendCommand( SECTION_ID_SYSTEM, CCommand_LaunchSection(CSectionB_CLSID,777,SF_BOUND) );

//	CTCommandSender<CCommand_LaunchSection>::SendCommand( SECTION_ID_SYSTEM, CCommand_LaunchSection(CSectionB_CLSID,777,SF_BOUND|SF_EXCLUSIVE) );
//	CTCommandSender<CCommand_LaunchSection>::SendCommand( SECTION_ID_SYSTEM, CCommand_LaunchSection(CSectionB_CLSID,888,SF_BOUND|SF_EXCLUSIVE) );

	CTCommandSender<CCommand_LaunchSection>::SendCommand( SECTION_ID_SYSTEM, CCommand_LaunchSection(CSectionB_CLSID,666,SF_BOUND|SF_EXCLUSIVE) );
...
CSectionA::Reaction( const CCommand_LaunchSectionResult& in_rResult )
{
	...
	if(666==in_rResult.m_Magic)
	{
		CTCommandSender<CCommand_LaunchSection>::SendCommand( SECTION_ID_SYSTEM, CCommand_LaunchSection(CSectionB_CLSID,999,SF_BOUND|SF_PARTNER,in_rResult.m_NewSectionID) );
	}
